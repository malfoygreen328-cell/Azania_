...
/* =====================================================
   ...
   POST /api/products
===================================================== */
router.post("/", verifyToken, requireRole("vendor_owner"), async (req, res) => {
  try {
...
/* =====================================================
   ...
   PUT /api/products/:id
===================================================== */
router.put("/:id", verifyToken, requireRole("vendor_owner", "admin"), async (req, res) => {
  try {
...
===================================================== */
router.delete("/:id", verifyToken, requireRole("vendor_owner", "admin"), async (req, res) => {
  try {
    const product = await Product.findById(req.params.id);
